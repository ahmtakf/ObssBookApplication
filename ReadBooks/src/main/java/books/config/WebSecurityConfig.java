...
import books.security.NoRedirectStrategy;
import books.security.TokenAuthenticationProvider;
import books.security.TokenAuthenticationFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final RequestMatcher PROTECTED_URLS = new NegatedRequestMatcher(USER_URLS);
