...
class AdminProfile extends React.Component{
    ...
    addAuthor()
    {
        this.setState({navigate:true, redirect:"/addauthor"});
    }

    addBook()
    {
        this.setState({navigate:true, redirect:"/addbook"});
    }
    ...
    render()
    {
        if(!this.state.navigate)
            return  <div>
                ...
                <button style={bStyle} onClick={this.addBook}>Add Book</button>
                <button style={bStyle} onClick={this.addAuthor}>Add Author</button>
